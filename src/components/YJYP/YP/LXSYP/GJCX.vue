  ...
  <div class="qwjs">
    ...
    <el-tabs type="border-card">
      <el-tab-pane label="基本信息">
        <el-row align="center"   :gutter="1">
          <el-col  :sm="24" :md="12" :lg="8"   class="input-item">
             ...
             <el-input placeholder="请输入内容" size="small" v-model="pdjb.zwxm" class="input-input"></el-input>
          </el-col>
          <el-col  :sm="24" :md="12" :lg="8"   class="input-item">
             <span class="input-text">英文姓名：</span>
             <el-input placeholder="请输入内容" size="small" v-model="pdjb.ywxm" class="input-input"></el-input>
          </el-col>
          <el-col  :sm="24" :md="12" :lg="8"  class="input-item">
          ...
          <el-col  :sm="24" :md="12" :lg="8"   class="input-item">
             ...
             <el-input placeholder="请输入内容" size="small" v-model="pdjb.zjhm" class="input-input"></el-input>
          </el-col>
       </el-row>
      ...
      <el-row align="center"   :gutter="1">
        ...
        <el-col  :sm="24" :md="12" :lg="8"   class="input-item">
           <span class="input-text">证件号码：</span>
           <el-input placeholder="请输入内容" size="small" v-model="pdqz.zjhm" class="input-input"></el-input>
        </el-col>
        <el-col  :sm="24" :md="12" :lg="8"  class="input-item">
      ...
      <el-tab-pane label="临住信息">
        <el-row align="center"   :gutter="1">
          <el-col  :sm="24" :md="12" :lg="8"   class="input-item">
             <span class="input-text">中文姓名：</span>
             <el-input placeholder="请输入内容" size="small" v-model="pdlz.zwxm" class="input-input"></el-input>
          </el-col>
          <el-col  :sm="24" :md="12" :lg="8"   class="input-item">
             <span class="input-text">英文姓名：</span>
             <el-input placeholder="请输入内容" size="small" v-model="pdlz.ywxm" class="input-input"></el-input>
          </el-col>
          <el-col  :sm="24" :md="12" :lg="8"   class="input-item">
            <span class="input-text">性别：</span>
          ...
          <el-col  :sm="24" :md="12" :lg="8"   class="input-item">
             <span class="input-text">证件号码：</span>
             <el-input placeholder="请输入内容" size="small" v-model="pdlz.zjhm" class="input-input"></el-input>
          </el-col>
          <el-col  :sm="24" :md="12" :lg="8"  class="input-item">
              <span class="input-text">国家地区：</span>
          ...
          <el-col  :sm="24" :md="12" :lg="8"   class="input-item">
             ...
             <el-input placeholder="请输入内容" size="small" v-model="pdlz.lsdwdz" class="input-input"></el-input>
          </el-col>
          <el-col  :sm="24" :md="12" :lg="8"   class="input-item">
             <span class="input-text">住宿单位名称：</span>
             <el-input placeholder="请输入内容" size="small" v-model="pdlz.bzhdzmc" class="input-input"></el-input>
          </el-col>
          <el-col  :sm="24" :md="12" :lg="8"   class="input-item">
             <span class="input-text">房号：</span>
             <el-input placeholder="请输入内容" size="small" v-model="pdlz.fh" class="input-input"></el-input>
          </el-col>
            <el-col  :sm="24" :md="12" :lg="8"  class="input-item">
      ...
      <el-tab-pane label="常住信息">

        <el-row align="center"   :gutter="1">
          <el-col  :sm="24" :md="12" :lg="8"   class="input-item">
             <span class="input-text">中文姓名：</span>
             <el-input placeholder="请输入内容" size="small" v-model="pdcz.zwxm" class="input-input"></el-input>
          </el-col>
          <el-col  :sm="24" :md="12" :lg="8"   class="input-item">
             <span class="input-text">英文姓名：</span>
             <el-input placeholder="请输入内容" size="small" v-model="pdcz.ywxm" class="input-input"></el-input>
          </el-col>
          <el-col  :sm="24" :md="12" :lg="8"   class="input-item">
            <span class="input-text">性别：</span>
          ...
          <el-col  :sm="24" :md="12" :lg="8"   class="input-item">
             <span class="input-text">证件号码：</span>
             <el-input placeholder="请输入内容" size="small" v-model="pdcz.zjhm" class="input-input"></el-input>
          </el-col>
          <el-col  :sm="24" :md="12" :lg="8"  class="input-item">
              <span class="input-text">签证种类：</span>
          ...
          <el-col  :sm="24" :md="12" :lg="8"   class="input-item">
             ...
             <el-input placeholder="请输入内容" size="small" v-model="pdcz.qzhm" class="input-input"></el-input>
          </el-col>
          <el-col  :sm="24" :md="12" :lg="8"  class="input-item">
          ...
          <el-col  :sm="24" :md="12" :lg="8"   class="input-item">
             ...
             <el-input placeholder="请输入内容" size="small" v-model="pdcz.sfzh" class="input-input"></el-input>
          </el-col>
          <el-col  :sm="24" :md="12" :lg="8"  class="input-item">
              <span class="input-text">国家地区：</span>
          ...
          <el-col  :sm="24" :md="12" :lg="8"   class="input-item">
             ...
             <el-input placeholder="请输入内容" size="small" v-model="pdcz.fwcs" class="input-input"></el-input>
          </el-col>
            <el-col  :sm="24" :md="12" :lg="8"   class="input-item">
              <span class="input-text">停留事由：</span>
      ...
      <el-tab-pane label="常住居住地信息">
        <el-row align="center"   :gutter="1">
          ...
          <el-col  :sm="24" :md="12" :lg="8"   class="input-item">
             ...
             <el-input placeholder="请输入内容" size="small" v-model="pdczjzd.xxdz" class="input-input"></el-input>
          </el-col>
          <el-col  :sm="24" :md="12" :lg="8"   class="input-item">
             <span class="input-text">房主姓名：</span>
             <el-input placeholder="请输入内容" size="small" v-model="pdczjzd.fzxm" class="input-input"></el-input>
          </el-col>
          <el-col  :sm="24" :md="12" :lg="8"  class="input-item">
            <span class="input-text">登记日期：</span>
              <el-date-picker class="input-input"
          ...
          <el-col  :sm="24" :md="12" :lg="8"   class="input-item">
             ...
             <el-input placeholder="请输入内容" size="small" v-model="pdczjzd.gxdw" class="input-input"></el-input>
          </el-col>
      </el-row>
      </el-tab-pane>
      <el-tab-pane label="常住工作地信息">
        <el-row align="center"   :gutter="1">
        <el-col  :sm="24" :md="12" :lg="8"   class="input-item">
           <span class="input-text">更新人：</span>
           <el-input placeholder="请输入内容" size="small" v-model="pdczgzd.gxr" class="input-input"></el-input>
        </el-col>
        <el-col  :sm="24" :md="12" :lg="8"   class="input-item">
           <span class="input-text">更新单位：</span>
           <el-input placeholder="请输入内容" size="small" v-model="pdczgzd.gxdw" class="input-input"></el-input>
        </el-col>
        <el-col  :sm="24" :md="12" :lg="8"   class="input-item">
           <span class="input-text">登记单位：</span>
           <el-input placeholder="请输入内容" size="small" v-model="pdczgzd.djdw" class="input-input"></el-input>
        </el-col>
        <el-col  :sm="24" :md="12" :lg="8"   class="input-item">
           <span class="input-text">详细地址：</span>
           <el-input placeholder="请输入内容" size="small" v-model="pdczgzd.xxdz" class="input-input"></el-input>
        </el-col>
        <el-col  :sm="24" :md="12" :lg="8"   class="input-item">
           <span class="input-text">工作地电话：</span>
           <el-input placeholder="请输入内容" size="small" v-model="pdczgzd.gzd_gzdh" class="input-input"></el-input>
        </el-col>
        <el-col  :sm="24" :md="12" :lg="8"   class="input-item">
           <span class="input-text">工作单位名称：</span>
           <el-input placeholder="请输入内容" size="small" v-model="pdczgzd.gzd_mc" class="input-input"></el-input>
        </el-col>
      </el-row>
      </el-tab-pane>
      <el-tab-pane label="案件信息">
        ...
        <el-col  :sm="24" :md="12" :lg="8"   class="input-item">
           ...
           <el-input placeholder="请输入内容" size="small" v-model="pdaj.ajmc" class="input-input"></el-input>
        </el-col>
        <el-col  :sm="24" :md="12" :lg="8"   class="input-item">
           <span class="input-text">案件性质：</span>
           <el-input placeholder="请输入内容" size="small" v-model="pdaj.ajxz" class="input-input"></el-input>
        </el-col>
        <el-col  :sm="24" :md="12" :lg="8"   class="input-item">
           <span class="input-text">案件类型：</span>
           <el-input placeholder="请输入内容" size="small" v-model="pdaj.ajlb" class="input-input"></el-input>
        </el-col>
        <el-col  :sm="24" :md="12" :lg="8"   class="input-item">
        ...
        <el-col  :sm="24" :md="12" :lg="8"   class="input-item">
           <span class="input-text">简要案情：</span>
            <el-input placeholder="请输入内容" size="small" v-model="pdaj.jyaq" class="input-input"></el-input>
        </el-col>
        <el-col  :sm="24" :md="12" :lg="8"   class="input-item">
           <span class="input-text">主办单位：</span>
            <el-input placeholder="请输入内容" size="small" v-model="pdaj.zbdw" class="input-input"></el-input>
        </el-col>
         <el-col  :sm="24" :md="12" :lg="8"   class="input-item">
             <span class="input-text">修改单位：</span>
              <el-input placeholder="请输入内容" size="small" v-model="pdaj.xgdw" class="input-input"></el-input>
          </el-col>
          <el-col  :sm="24" :md="12" :lg="8"   class="input-item">
           ...
           <el-col  :sm="24" :md="12" :lg="8"   class="input-item">
               <span class="input-text">案件地址名称：</span>
                <el-input placeholder="请输入内容" size="small" v-model="pdaj.badwdz" class="input-input"></el-input>
            </el-col>
      </el-row>
      </el-tab-pane>
    </el-tabs>
