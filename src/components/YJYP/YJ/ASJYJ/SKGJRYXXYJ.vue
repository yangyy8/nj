    ...
    <div class="yycontent">
      <el-table
        ...
        <el-table-column
         ...
         <el-button type="text"  class="a-btn"  title="编辑"  icon="el-icon-edit-outline" @click="$router.push({name:'SKGJRYXXYJ_XQ',query:{rybh:scope.row.rybh,yjid:scope.row.yjid}})"></el-button>
         </template>
        </el-table-column>
      </el-table>
