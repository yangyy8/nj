        ...
        <el-col :span="22" class="br pr-20">
          <el-row align="center"   :gutter="2">
            ...
            <el-col  :sm="24" :md="12" :lg="8"  class="input-item">
                ...
                <el-select v-model="pd.XZQH" filterable clearable default-first-option placeholder="请选择"  size="small" class="input-input">
                  <el-option
            ...
            <el-col  :sm="24" :md="12" :lg="8"  class="input-item">
                ...
                <el-col  :sm="24" :md="12" :lg="8"  class="input-item">
                  ...
                  <div class="input-input t-flex t-date">
                    <el-date-picker
                       v-model="pd.yjrqStart1" format="yyyy-MM-dd"
                       type="date" size="small" value-format="yyyy-MM-dd"
                       placeholder="开始时间" >
                    </el-date-picker>
                    <span class="septum">-</span>
                    <el-date-picker
                        v-model="pd.yjrqEnd1" format="yyyy-MM-dd"
                        type="date" size="small" value-format="yyyy-MM-dd"
                        placeholder="结束时间" >
                    </el-date-picker>
                 </div>
    ...
    <div class="yycontent">
      ...
      <el-table
           ...
           <el-table-column
             ...
             <el-button type="text"  class="a-btn"  title="详情"  icon="el-icon-document" @click="$router.push({name:'CZFWYHYJ_XQ',query:{yjType:5,rybh:scope.row.rybh}})"></el-button>
             </template>
           </el-table-column>
         </el-table>
