      ...
      <el-row align="center"   :gutter="2">
        <el-col  :sm="24" :md="12" :lg="8"   class="input-item">
          ...
          <el-checkbox-group
            ...
            <el-checkbox v-for="(city,index) in cities1" :label="city.id" :key="index"  @change="getZJ(city.mxmc,1,city.mxsm)">
              {{city.mxsm}}
            </el-checkbox>
          </el-checkbox-group>
        </el-card>
        ...
        <el-col  :sm="24" :md="12" :lg="8"  class="input-item" v-if="card1">
          ...
          <el-checkbox-group
            ...
            <el-checkbox v-for="city in cities2" :label="city.id" :key="city.id"  @change="getZJ(city.gzmc,2,city.gzsm)">
              {{city.gzsm}}
            </el-checkbox>
          </el-checkbox-group>
        </el-card>
